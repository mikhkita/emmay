...
<div id="all" class="page-main">	
	...
	<div class="b-allwrap">	
		...
		<div id="order-basket" class="active">
			...
			<div class="b-wrap clearfix">
					...
					<tbody>
					    ...
					    <tr>
					   		<td class="item-title">
					   			<div>
					   				<div class="img-cont">
							   			<img src="i/basket-table.jpg">	   			
						   			</div>
						   			<h4 class="sub-title">Букет из 11 красных роз</h4>
						   		</div>
					   		</td>
					   		<td>
				...
				<div class="basket-bot clearfix">
					<div class="addition left">
						<div class="clearfix">
							<label class="left free-card">Бесплатная открытка</label>
							<textarea class="right" name="" placeholder="Введите текст поздравления. Если открытка не нужна, то оставьте поле пустым"></textarea>
						</div>
						<div class="clearfix">
					...
					<div class="total right">
						<div class="clearfix">
							...
							<input type="button" class="next btn btn-g right b-issue" data-width="1200" data-step="#order-contacts" data-value="Оформить" value="Далее">
						</div>
			...
			<div class="b-container flower-add">
			<div class="b-wrap clearfix">
				<h3 class="title">ПРИЯТНЫЕ ДОПОЛНЕНИЯ К БУКЕТУ</h3>
				<ul>
					<li class="clearfix">
						<div class="left">
							<img src="i/ballon.jpg" alt="">
						</div>
						<div class="right">
		...
		<div id="order-contacts">
			<div class="b-container order">
				<div class="b-wrap clearfix">
					...
					<input type="button" class="next btn btn-g right b-issue" data-width="1200" data-step="#order-contacts-2" data-value="Оформить" value="Далее">
				</div>
			</div>
		</div>
		<div id="order-contacts-2">
			<div class="b-container order">
				<div class="b-wrap clearfix">
					<div class="order-item">
					...
					<input type="button" class="next btn btn-g right b-issue" data-width="1200" data-step="#order-delivery" data-value="Оформить" value="Далее">
				</div>
			</div>
		</div>
		<div id="order-delivery">
			<div class="b-container order">
				<div class="b-wrap clearfix">
					...
					<input type="button" class="next btn btn-g right b-issue" data-width="1200" data-step="#order-payment" data-value="Оформить" value="Далее">
				</div>
			</div>
		</div>
