	...
	<div class="b-allwrap">	
		...
		<div class="b-container b-navigation">
			<div class="b-container b-nav" data-spy="affix" data-offset-top="181" data-offset-bottom="200">
				...
				<div class="b-container b-subblock active">
			...
			<div class="b-wrap clearfix">
				...
				<div class="order-item">
					...
					<div class="check-cont clearfix">
						<input type="checkbox" id="1" name="self" value="self">
				...
				<div class="total right">
						<div class="clearfix">
							...
							<input type="submit" class="btn btn-g right" value="Перейти к оформлению">
							<div class="left">
