					...
					<div class="yamme-text-block">
						...
						<div class="b-contacts-cont">
							...
							<ul class="contacts-list">
								...
								<li><a href="#" class="contact-city">Адлер</a></li>
							</ul>
						</div>
						<div class="b-contacts-cont">
							<div class="b-contacts-name">Б</div>
							<ul class="contacts-list">
								<li>
									<a href="#">Бердск</a>
								</li>
								<li><a href="#" class="contact-city">Борисполь</a></li>
							</ul>
						</div>
						<div class="b-not-found">ничего не найдено</div>
						<div class="b-contacts-name contacts-part">Весь мир</div>
						<div class="b-contacts-name">А</div>
						<ul class="contacts-list">
							<li>
								<a href="#">Албания</a>
							</li>
							<li><a href="#" class="contact-city">Алжир</a></li>
						</ul>
						<div class="b-contacts-name">С</div>
						<ul class="contacts-list">
							<li>
								<a href="#">США</a>
							</li>
							<li>
								<a href="#" class="contact-city">Саудовская аравия</a>
							</li>
						</ul>
					</div>
					<div class="yamme-text-block">
						<h2>Условия доставки сео текст</h2>
						<p>123</p>
						<p>321</p>
					</div>	
				</div>
