		...
		<div class="b-container item">
			<div class="b-wrap clearfix">
				<div class="b-item-left">
					...
					<div class="b-item-gallery">
						...
						<div class="royalSlider rsDefault">
							...
							<a class="rsImg"  href="i/t/item-2.jpg"><img width="86" height="86" class="rsTmb" src="i/t/item-2_.jpg"  data-zoom-image="i/t/item-11.jpg"/></a>
							<a class="rsImg"  href="i/t/item-1.jpg"><img width="86" height="86" class="rsTmb" src="i/t/item-1_.jpg"  data-zoom-image="i/t/item-11.jpg"/></a>
							<a class="rsImg"  href="i/t/item-2.jpg"><img width="86" height="86" class="rsTmb" src="i/t/item-2_.jpg"  data-zoom-image="i/t/item-11.jpg"/></a>
							<a class="rsImg"  href="i/t/item-1.jpg"><img width="86" height="86" class="rsTmb" src="i/t/item-1_.jpg"  data-zoom-image="i/t/item-11.jpg"/></a>
							<a class="rsImg"  href="i/t/item-2.jpg"><img width="86" height="86" class="rsTmb" src="i/t/item-2_.jpg"  data-zoom-image="i/t/item-11.jpg"/></a>
							<a class="rsImg"  href="i/t/item-1.jpg"><img width="86" height="86" class="rsTmb" src="i/t/item-1_.jpg"  data-zoom-image="i/t/item-11.jpg"/></a>
				...
				<div class="b-item-right">
					...
					<div class="b-item-about clearfix">
						<div class="b-item-kit">
							<h4>Состав букета:</h4>
							<ul>
								<li>15 роз</li>
								<li>Лента в цвет букета</li>
							</ul>
							<div class="b-share-info">
					...
					<div class="b-item-reviews clearfix">
						<h4>Отзывы:</h4>
						<div class="b-review-item">
				        	<p>Большое спасибо!<br/>Цветы отличные,девушка моя была приятно удивлена. Отправлял из Сургута в Севастополь. Отдельное спасибо менеджеру.	Цветы отличные,девушка моя была приятно удивлена. Отправлял из Сургута в Севастополь. Отдельное спасибо менеджеру.</p>
							<p class="b-review-from">22 Апреля 2015, отзыв от Виталий (Доставка 22.04.15)</p>
				        </div>
				        <div class="b-review-item">
				        	<p>Большое спасибо!<br/>Цветы отличные,девушка моя была приятно удивлена. Отправлял из Сургута в Севастополь. Отдельное спасибо менеджеру.	Цветы отличные,девушка моя была приятно удивлена. Отправлял из Сургута в Севастополь.</p>
							<p class="b-review-from">22 Апреля 2015, отзыв от Виталий (Доставка 22.04.15)</p>
				        </div>
				        <div class="b-review-item">
				        	<p>Большое спасибо!<br/>Цветы отличные,девушка моя была приятно удивлена. Отправлял из Сургута в Севастополь. Отдельное спасибо менеджеру.	Цветы отличные,девушка моя была приятно удивлена. Отправлял из Сургута в Севастополь. Отдельное спасибо менеджеру.</p>
			        ...
			        <ul class="b-catalog-list">
						<li>
							<div class="b-catalog-item clearfix">
								<a href="#" class="b-cat-pic left">
									<img alt="" src="i/t/t1.jpg" />
								</a>
								<div class="right">
									<span class="b-catalog-list-title">Яркие краски (9 роз)</span>
									<p>
