...
<div id="all" class="page-main">	
	...
	<div class="b-allwrap">	
		...
		<div class="b-container coupon">
			<div class="b-wrap clearfix">
				<div class="coupon-cont left">
					<h2 class="b-title">Купон на скидку</h2>
					<form class="coupon-form clearfix" action="ajax/coupon.php" method="POST">
						<div class="input-cont clearfix">
							<label class="left">Купон*</label>
							<input class="right" type="text" name="coupon" required>	
						</div>
						<div class="input-cont clearfix">
							<label class="left">Номер телефона*</label>
							<input class="right" type="text" name="phone" required>	
						</div>
						<input type="submit" class="btn btn-g right" value="Проверить">
					</form>
					<h4 class="message right">&nbsp;</h4>
				</div>
				<div class="order-number left">
					<h2 class="b-title">Проверка статуса заказа</h2>
					<form class="coupon-form clearfix" action="ajax/coupon.php" method="POST">
						<div class="input-cont clearfix">
							<label class="left">Номер заказа</label>
							<input class="right" type="text" name="order" required>	
						</div>
						<input type="submit" class="btn btn-g right" value="Проверить">
					</form>
					<h4 class="message right">&nbsp;</h4>
